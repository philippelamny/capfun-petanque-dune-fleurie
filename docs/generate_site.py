...
def build_html(version, releases, web_app):
    ...
    <section id="ajout-ecran-accueil">
      <h2>Ajouter l'appli web à l'écran d'accueil</h2>
      <p>Sur iPhone comme sur Android, l'appli web peut s'installer comme une vraie icône, sans passer par un store.</p>
      <div class="features-grid">
        <div class="feature-card">
          <h3>📱 iPhone / iPad (Safari)</h3>
          <p>
            1. Ouvrez <a href="appli/">l'appli web</a> dans Safari.<br />
            2. Appuyez sur le bouton Partager (le carré avec la flèche vers le haut).<br />
            3. Choisissez « Sur l'écran d'accueil ».<br />
        ...
        <div class="feature-card">
          ...
          <p>
            1. Ouvrez <a href="appli/">l'appli web</a> dans Chrome.<br />
            2. Appuyez sur le menu ⋮ en haut à droite.<br />
      ...
      <div class="callout" style="margin-top: 20px;">
        <h3 style="margin-top:0;">⚠️ Attention au vidage du cache</h3>
        <p>Les tournois en cours sont enregistrés uniquement dans le stockage du navigateur (ou de l'icône installée). Si vous videz le cache/les données du navigateur (ou de l'appli ajoutée à l'écran d'accueil), ou si vous la désinstallez, <strong>vos tournois en cours seront perdus</strong>. Évitez de « vider le cache » ou « effacer les données de navigation » de Safari/Chrome tant qu'un tournoi n'est pas terminé.</p>
      </div>
    </section>'''
    else:
        web_app_section = ''
